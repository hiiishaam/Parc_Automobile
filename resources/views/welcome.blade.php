...
<a href="{{route('utilisateurs.index') }}" class="btn btn-primary">Utilisateur</a>
        ...
        <div class="navigation">
            <ul>
                ...
                <li>
                    ...
                    <a href="{{route('utilisateurs.index') }}" class="btn btn-primary">
                        <span class="icon">
                ...
                <li>
                <a href="{{route('typesVehicules.index') }}" class="btn btn-primary">
                        <span class="icon">
                ...
                <li>
                <a href="{{route('carburants.index') }}" class="btn btn-primary">
                        <span class="icon">
                            <ion-icon name="settings-outline"></ion-icon>
                        </span>
